return {
  -- TODO: old rustaceanvim config - seems to mess with the default one provided by lazyvim so
  -- disabled for now
  ...
  --             -- old env var - testing out one from h3r2tic on discord
